...
This method returns an [`ApiResponse`](../../doc/api-response.md) instance. The `result` property of this instance returns the response data which is of type [GetAccountScheduledPaymentsResponse](../../doc/models/get-account-scheduled-payments-response.md).
...
This method returns an [`ApiResponse`](../../doc/api-response.md) instance. The `result` property of this instance returns the response data which is of type [GetScheduledPaymentsResponse](../../doc/models/get-scheduled-payments-response.md).
