...
This method returns an [`ApiResponse`](../../doc/api-response.md) instance. The `result` property of this instance returns the response data which is of type [BeneficiariesGETresponse](../../doc/models/beneficiaries-ge-tresponse.md).
